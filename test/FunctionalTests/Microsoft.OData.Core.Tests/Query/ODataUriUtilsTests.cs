    ...
    public class ODataUriUtilsTests
    {
        ...
        public void TestResourceSetConvertFromUriLiteral()
        {
         ...
         //   Assert.NotNull(setValue.ResourceSet);
            ...
            Assert.Equal(2, setValue.ResourceItems.Count());
            ODataNestedResourceValue resourceValue = setValue.ResourceItems[0] as ODataNestedResourceValue;
            ...
            // Item2
            resourceValue = setValue.ResourceItems[1] as ODataNestedResourceValue;
            ...
            Assert.NotNull(resourceValue.NestedProperties);
            var nestedItem = Assert.Single(resourceValue.NestedProperties);
            Assert.NotNull(nestedItem.NestedResourceInfo);
            Assert.Equal("Location", nestedItem.NestedResourceInfo.Name);
            Assert.NotNull(nestedItem.Value);
            var nestedResource = Assert.IsType<ODataNestedResourceValue>(nestedItem.Value);
        ...
        public void TestResourceWithNestedResourceConvertFromUriLiteral()
        {
            ...
            ODataNestedResourceValue value = new ODataNestedResourceValue(resource)
            {
                NestedProperties = new[] {
                    new ODataNestedProperty(nestedResourceInfo)
                    {
                        Value = new ODataNestedResourceValue(nestedResource)
                    }
                }
            };
        ...
        public void TestResourceSetConvertToUriLiteral()
        {
            ...
            {
                TypeName = "Collection(NS.Address)",
                ResourceItems = new[] { new ODataNestedResourceValue(resource), value }
            };
        ...
        [Fact]
        public void TestResourceSetConvertToUriLiteralWithInstanceAnnotation()
        {
            EdmModel model = new EdmModel();
            var complex = new EdmComplexType("NS", "Address");
            complex.AddStructuralProperty("Street", EdmPrimitiveTypeKind.String);
            ...
            value.InstanceAnnotations.Add(new ODataInstanceAnnotation("Custom.MyPrimittive", new ODataPrimitiveValue(1)));
            ...
            /*
            setValue.InstanceAnnotations = new List<ODataInstanceAnnotation>
            {
                new ODataInstanceAnnotation("Custom.MyAnnotation", value)
            };*/
