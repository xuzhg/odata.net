...
namespace Microsoft.OData.Edm.Csdl.Reader
{
    ...
    internal class JsonPrimitiveValue : IJsonValue
    {
        ...
        public JsonValueType ValueType => JsonValueType.JPrimitive;
    }
    ...
    internal class JsonObjectValue : Dictionary<string, IJsonValue>, IJsonValue
    {
        ...
        public JsonValueType ValueType => JsonValueType.JObject;
    ...
    {
        public JsonValueType ValueType => JsonValueType.JArray;
    }
}
