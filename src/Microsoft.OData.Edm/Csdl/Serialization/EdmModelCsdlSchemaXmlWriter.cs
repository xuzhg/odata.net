...
namespace Microsoft.OData.Edm.Csdl.Serialization
{
    internal class EdmModelCsdlSchemaXmlWriter : EdmModelCsdlSchemaWriter
    {
        ...
        internal override void WriteNavigationPropertyBinding(IEdmNavigationSource navigationSource, IEdmNavigationPropertyBinding binding)
        {
        ...
        internal override void WriteSchemaElementEnd(EdmSchema schema, string alias)
        {
            WriteEndElement();
        }
